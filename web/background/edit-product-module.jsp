...
<c:set var="book_id" value="${requestScope.get('book_id')}"/>
...
<c:set var="book_publish_data" value="${requestScope.get('book_publish_data')}"/>
<c:set var="book_price" value="${requestScope.get('book_price')}"/>
<c:set var="book_imgUrl" value="${requestScope.get('book_imgUrl')}"/>

<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>编辑商品 - 网上商城管理系统</title>
	...
	<form action="${ctx}/admin/edit-product.do" method="post" enctype="multipart/form-data">
		<table align="center" class="imgtable">
			<tr>
				...
				<td><input type="text" name="id" value="${book_id}" readonly="readonly"/></td>
				<td></td>
			</tr>
			<tr>
			...
			<tr>
				<td>图书类型：</td>
				<td>
					<select name="book_type" id="book-type">
